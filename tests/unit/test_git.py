...
def test_commit_version_with_yarn_mappings_stages_the_src_directory(config, empty_repo, yarn_mappings):
	# Call commit_version
...
def test_commit_version_with_mojang_mappings_stages_the_src_directory(config, empty_repo, mojang_mappings):
	# Call commit_version
	version = Version('1.18.1', 0)
	shulkr.commit_version(version, undo_renamed_vars=False, message_template='{}')
...
def test_commit_version_replaces_all_brackets_with_the_version(config, empty_repo):
	# Call commit_version
	message_template = '{} {}'
	version = Version('1.18.1', 0)
...
def test_commit_version_with_existing_commits_and_undo_renamed_vars_adds_note_to_commit_message(config, nonempty_repo):
	# Call commit_version
	version = Version('1.18.1', 0)
